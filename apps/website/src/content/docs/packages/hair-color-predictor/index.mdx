---
title: "@avatune/hair-color-predictor"
description: "Browser-based hair color prediction using TensorFlow.js. Classifies hair into 4 categories: black, brown, blond, gray."
...
<InstallTabs packages="@avatune/hair-color-predictor @tensorflow/tfjs" />
