...
[![npm version](https://img.shields.io/npm/v/@avatune/facial-hair-predictor)](https://www.npmjs.com/package/@avatune/facial-hair-predictor)
[![npm bundle size](https://img.shields.io/npm/unpacked-size/@avatune/facial-hair-predictor)](https://www.npmjs.com/package/@avatune/facial-hair-predictor)
...
```bash
npm install @avatune/facial-hair-predictor @tensorflow/tfjs
```
